...
import org.ggll.actions.IPropertyManager;
import org.ggll.actions.JEditBeanShellAction;
import org.ggll.actions.Mode;
import org.ggll.editor.buffer.DefaultFoldHandlerProvider;
import org.ggll.editor.buffer.DummyFoldHandler;
import org.ggll.editor.buffer.ExplicitFoldHandler;
import org.ggll.editor.buffer.FoldHandler;
import org.ggll.editor.buffer.IndentFoldHandler;
import org.ggll.editor.buffer.JEditBuffer;
import org.ggll.editor.buffer.KillRing;
import org.ggll.editor.syntax.ModeProvider;
import org.ggll.editor.syntax.ParserRuleSet;
import org.ggll.editor.syntax.SyntaxStyle;
import org.ggll.editor.syntax.TokenMarker;
import org.ggll.util.IOUtilities;
import org.ggll.util.Log;
import org.ggll.util.SyntaxUtilities;
...
public class StandaloneTextArea extends TextArea
{
	...
	public static StandaloneTextArea createTextArea()
	{
		...
		props.putAll(loadProperties("/org/ggll/actions/jedit_keys.props"));
		props.putAll(loadProperties("/org/ggll/actions/jedit.props"));
