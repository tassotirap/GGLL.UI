...
import org.ggll.ui.wizard.RoutineWizard;
...
public class CanvasPopupMenu extends WidgetAction.Adapter implements PopupMenuProvider
{
	...
	private JMenuItem createSemanticRoutinesMenu()
	{
		...
		CoreManager.setSemanticFile(GGLLManager.getProject().getSemanticFile());
		Set<String> semanticRoutinesNames = SemanticRoutinesHelper.getRegRoutines();
