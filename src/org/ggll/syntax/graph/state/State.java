...
public class State implements Serializable, PropertyChangeListener {
	...
	public static State read(final String file) throws IOException,
	...
	public String getFullFileName() {
		return GGLLFacade.getInstance().getProjectDir() + "\\" + getFileName();
	}
	...
	public void propertyChange(final PropertyChangeEvent evt) {
		if (evt.getPropertyName().equals("writing")) {
			final SyntaxGraph canvas = SyntaxGraphRepository.getInstance(getFullFileName());
			if (canvas != null) {
				refresh(canvas);
			}
		}
	...
	public void write() throws IOException {
		...
		final FileOutputStream fileOutputStream = new FileOutputStream(getFullFileName());
