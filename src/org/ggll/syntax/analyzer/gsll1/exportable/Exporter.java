package org.ggll.syntax.analyzer.gsll1.exportable;
...
public class Exporter
{
	...
	public void export() throws IOException, FileNotFoundException
	{
		...
		IOUtilities.copyFileFromInputSteam(getClass().getResourceAsStream("/org/ggll/syntax/analyzer/gsll1/exportable/Yytoken.txt"), new File(rootPath, "export_code/Yytoken.java"));
		IOUtilities.copyFileFromInputSteam(getClass().getResourceAsStream("/org/ggll/syntax/analyzer/gsll1/exportable/ParseStackNode.txt"), new File(rootPath, "export_code/ParseStackNode.java"));
		IOUtilities.copyFileFromInputSteam(getClass().getResourceAsStream("/org/ggll/syntax/analyzer/gsll1/exportable/SemanticRoutines.txt"), new File(rootPath, "export_code/SemanticRoutines.java"));
		File libDir = new File(rootPath, "export_code/lib");
		if (!libDir.exists())
		{
			libDir.mkdir();
		}
		IOUtilities.copyFileFromInputSteam(getClass().getResourceAsStream("/org/ggll/syntax/analyzer/gsll1/exportable/lib/groovy-1.5.6.jar"), new File(rootPath, "export_code/lib/groovy-1.5.6.jar"));
		IOUtilities.copyFileFromInputSteam(getClass().getResourceAsStream("/org/ggll/syntax/analyzer/gsll1/exportable/lib/asm-2.2.3.jar"), new File(rootPath, "export_code/lib/asm-2.2.3.jar"));
		IOUtilities.copyFileFromInputSteam(getClass().getResourceAsStream("/org/ggll/syntax/analyzer/gsll1/exportable/lib/antlr-2.7.6.jar"), new File(rootPath, "export_code/lib/antlr-2.7.6.jar"));
		IOUtilities.copyFileFromInputSteam(getClass().getResourceAsStream("/org/ggll/syntax/analyzer/gsll1/exportable/lib/license.txt"), new File(rootPath, "export_code/lib/license.txt"));
		...
		{
			if (line.contains("import org.ggll.syntax.model.ParseNode"))
			{
				line = line.replace("import org.ggll.syntax.model.ParseNode", "import org.grview.syntax.analyzer.gsll1.exportable.ParseNode");
			}
			result += line + "\n";
		}
		br.close();
		...
		if (yylex.exists())
		{
			...
			while ((line = br.readLine()) != null)
			{
				...
				else if (line.contains("import org.ggll.lexical.*;"))
				{
				}
				else if (line.contains("import org.ggll.syntax.model.*;"))
				{
				}
				...
				else if (line.matches(".*implements org.ggll.lexical.Yylex.*"))
				{
					result += line.replaceFirst("implements org.ggll.lexical.Yylex", "") + "\n";
		...
		InputStream af = getClass().getResourceAsStream("/org/ggll/syntax/analyzer/gsll1/exportable/Analyzer.txt");
