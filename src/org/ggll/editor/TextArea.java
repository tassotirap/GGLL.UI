...
import org.ggll.bsh.input.TextAreaInputHandler;
import org.ggll.editor.buffer.JEditBuffer;
import org.ggll.editor.syntax.Chunk;
...
public abstract class TextArea extends JComponent implements ActionContextHolder<JEditBeanShellAction, AsinActionSet<JEditBeanShellAction>>
{
	...
	protected static class StandaloneActionSet extends AsinActionSet<JEditBeanShellAction>
	{
		...
		{
			super(null, TextArea.class.getResource("/org/ggll/actions/xml/textarea.actions.xml"));
	 ...
	 * {@link org.ggll.actions.EditPane#setBuffer(org.ggll.actions.Buffer)}
	 * instead.
	 * 
	 * @param buffer
	 *            The buffer
