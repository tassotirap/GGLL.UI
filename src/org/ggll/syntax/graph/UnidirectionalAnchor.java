...
public class UnidirectionalAnchor extends Anchor
{
	...
	public UnidirectionalAnchor(SyntaxGraph canvas, Widget widget, Direction kind)
	{
		this(canvas, widget, kind, null, null);
	}

	public UnidirectionalAnchor(SyntaxGraph canvas, Widget widget, Direction kind, String connection, Direction preferredDirection)
	{
		super(widget);
		this.canvas = canvas;
		this.kind = kind;
